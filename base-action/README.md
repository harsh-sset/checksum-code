...
jobs:
  code-review:
    ...
    steps:
      ...
      - name: Run Code Review with Checksum
        id: code-review
        uses: anthropics/claude-code-base-action@beta
        with:
      ...
      - name: Extract and Comment PR Review
        ...
        with:
          ...
          script: |
            ...
            // The execution log contains the full conversation including Checksum's responses
            let review = '';
            ...
            if (review) {
              github.rest.issues.createComment({
                ...
                body: "## Checksum Code Review\n\n" + review + "\n\n*Generated by Checksum*"
              });
            }
```
